...
for before,after in zip(old_units['units'], normalized_units['units']):
    if before['id']=='wc_u_dragonkin_rogue':
        after['art_direction']['risk']=before['art_direction']['risk']
