...
void ActualOrdinals(wc::Catalog catalog) {
    ...
    const int mira=Definition(catalog,"wc_u_human_mage");
    const int ada=Definition(catalog,"wc_u_human_guardian");
    const int cass=Definition(catalog,"wc_u_human_rogue");
    ...
    wc::Combat combat(catalog,{Owned(1,sylas,3,3),Owned(2,mira,2,3),Owned(3,ada,4,3),Owned(7,cass,3,2)},
                              {Owned(4,sylas,3,3),Owned(5,mira,2,3),Owned(6,ada,4,3),Owned(8,cass,3,2)},91823);
