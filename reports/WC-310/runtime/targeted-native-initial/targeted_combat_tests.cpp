...
std::vector<Formation> Formations() {
    return {
        {"shield_heavy", {{0,{2,3}},{6,{3,3}},{8,{4,3}},{4,{2,2}},{1,{3,2}},{10,{4,1}}}},
        {"sustain", {{0,{2,3}},{6,{4,3}},{5,{5,2}},{1,{2,2}},{4,{3,2}},{7,{4,1}}}},
...
void Matrix(const wc::Catalog& c) {
    ...
    for (const auto& f : formations) { int cost = 0; for (const auto& u : f.units) {
