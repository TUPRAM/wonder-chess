...
def candidate(report):
 ...
 for side,s in [('r',-1),('l',1)]:
  ...
  smooth=extra.modifiers.new('Sculpt_surface_relax','SMOOTH');smooth.factor=.40;smooth.iterations=3;bpy.ops.object.modifier_apply(modifier=smooth.name);dec=extra.modifiers.new('Sculpt_faceted_finish','DECIMATE');dec.ratio=.60;bpy.ops.object.modifier_apply(modifier=dec.name)
