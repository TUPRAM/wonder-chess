 ...
 for side,s in [('r',-1),('l',1)]:
  ...
  if side=='r':
   for j,z in enumerate((.714,.738,.762,.786)):
    pts=[(-.5824+.047*math.cos(a),.1001+.044*math.sin(a),z) for a in [math.radians(165-i*215/15) for i in range(16)]];hand.tube([tuple(q/h for q in p) for p in pts],[r/h for r in ([.0105]+[.0125]*14+[.0105])],6,'hand_r',10)
