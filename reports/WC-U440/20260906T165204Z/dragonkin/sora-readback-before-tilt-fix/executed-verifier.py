...
manifest=json.loads((out/'export_manifest.json').read_text());clips=[]
...
result=dict(status='PASS_ACTUAL_BLENDER_FBX_AND_VIDEO_READBACK',unit_id=uid,source_revision=manifest['source_revision'],
    ...
    finished_art_accepted=False,silhouettes=silhouettes,semantic_geometry=semantic,verification_script_sha256=VERIFIER_SHA)
