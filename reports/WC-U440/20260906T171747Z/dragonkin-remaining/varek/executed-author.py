    ...
    def dressed_equipment(g,u,p):
        if u['unit_class']!='guardian':
            ...
            if u['unit_class']=='ranger':
                ...
                g.tube([(-.058,.109,.778),(0,.119,.724),(.058,.109,.778)],[.0065]*3,4,'spine_03',8)
                for sign in (-1,1):
                    g.tube([(sign*.093,.103,.710),(sign*.085,.095,.652),(sign*.073,.094,.577)],[.003]*3,4,'spine_02',7)
                g.ellipsoid((0,.124,.725),(.012,.006,.009),4,'spine_03',5,10)
