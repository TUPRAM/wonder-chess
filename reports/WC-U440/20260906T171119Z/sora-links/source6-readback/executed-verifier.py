...
if prior.exists() and uid=='wc_u_dragonkin_guardian' and manifest['source_revision']>=3:
    signatures=[]
    ...
    assert changed==(['Active'] if manifest['source_revision']==3 else []),('Unexpected changed actions',changed)
