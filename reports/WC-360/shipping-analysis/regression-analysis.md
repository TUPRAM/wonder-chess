...
All 100 requested seeds are retained and finished. The game reports zero failed trials, zero rejected bot commands, zero unresolved encounters and successful evidence writes. Recorded batch elapsed time was 55.135160 seconds, 2026-09-06T07:21:05.939Z to 2026-09-06T07:22:01.099Z, on AMD Ryzen 7 6800H with Radeon Graphics. This NullRHI/no-sound run is simulation execution, not a render or audio benchmark.
...
Runtime-loaded profile and all five canonical data hashes agree with shipping-final-provenance.json. The actual Shipping inner executable SHA256 matches that immutable manifest.

Captured process exit_code is null: UNKNOWN. Complete game evidence and zero failed trials do not establish an OS exit code. No Shipping game.log is present, so engine log error/exit checks are NOT_RUN.
