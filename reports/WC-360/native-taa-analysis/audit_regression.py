"""Audit actual native-TAA Shipping regression against preserved engine and native rows."""
...
def main():
    report_path = ROOT / "reports/WC-360/native-taa-regression/regression.json"
    provenance_path = ROOT / "reports/WC-360/native-taa-provenance.json"
    ...
    lines += ["", "Runtime-loaded profile and all five canonical data hashes agree with native-taa-provenance.json. The actual Shipping inner executable SHA256 matches that immutable manifest.", "",
