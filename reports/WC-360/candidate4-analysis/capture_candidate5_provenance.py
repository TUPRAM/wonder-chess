"""Capture once, only after successful candidate5 packaging; never alter inputs."""
...
OUTPUT = ROOT / "reports/WC-360/candidate5-provenance.json"
PACKAGE = ROOT / "builds/Windows-Alpha"
PACKAGE_REPORTS = ROOT / "reports/WC-360/package"
...
def main():
    if OUTPUT.exists():
        raise SystemExit("Refusing to overwrite immutable candidate5 provenance")
    ...
    result = {"schema": "wonder_chess_candidate_provenance_v1", "candidate": "candidate5",
