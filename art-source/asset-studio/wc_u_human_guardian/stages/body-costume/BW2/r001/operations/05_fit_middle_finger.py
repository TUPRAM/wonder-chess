...
best=[20.,72.,52.];score,pad,worst=evaluate(best);count=1
...
s['BW2_middle_construction']=json.dumps({'angles':best,'pad_gaps_mm':pad,'whole_hand_min_sdf_mm':worst,'evaluations':count,'objective':score})
s.camera=bpy.data.objects['BW2_cam_oblique'];s.render.filepath='C:/Users/iputu/Documents/Wonder Chess/art-source/asset-studio/wc_u_human_guardian/stages/body-costume/BW2/r001/captures/middle_fitted_initial.png';bpy.ops.render.render(write_still=True)
print(s['BW2_middle_construction'])
