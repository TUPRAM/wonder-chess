...
evaluate(best)
s['BW2_thumb_correction1']=json.dumps({'params_deg':best,'mapping':['CMC_X','CMC_Y','CMC_Z','MCP_X','IP_X','IP_Z'],'pad_gaps_mm':pad,'whole_hand_min_sdf_mm':worst,'centroid_relative_handle':position,'evaluations':evalcount,'objective':score,'method':'bounded base opposition/axial-rotation search; fixed handle and all original pad samples retained'})
for nm in ['palm','oblique','axial']:
    s.camera=bpy.data.objects['BW2_cam_'+nm];s.render.filepath='C:/Users/iputu/Documents/Wonder Chess/art-source/asset-studio/wc_u_human_guardian/stages/body-costume/BW2/r001/captures/grip_correction1_'+nm+'.png';bpy.ops.render.render(write_still=True)
s.camera=bpy.data.objects['BW2_cam_oblique']
print(s['BW2_thumb_correction1'])
