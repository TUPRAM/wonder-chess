...
record=json.loads((out/'poses_initial.json').read_text())
...
render('sword_grip_initial','R',record['poses']['sword_grip'],True)
render('shield_grip_initial','L',record['poses']['shield_grip'],True)
render('sword_grip_initial_dorsal','R',record['poses']['sword_grip'],True,True)
