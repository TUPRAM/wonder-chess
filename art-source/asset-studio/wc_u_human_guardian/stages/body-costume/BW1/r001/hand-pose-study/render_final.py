...
render('sword_grip_final','R',record['poses']['sword_grip'],True)
render('shield_grip_final','L',record['poses']['shield_grip'],True)
render('sword_grip_final_dorsal','R',record['poses']['sword_grip'],True,True)
