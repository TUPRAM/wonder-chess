"""Compare source arrays in r003 with data loaded read-only from frozen r002; never save blends."""
...
prior=ROOT/'ada_body_costume_checkpoint_r002_ART_REVISE.blend'
...
(ROOT/'reviews/r003_work_exact_source_comparison.json').write_text(json.dumps(out,indent=2)+'\n')
