...
source=out.parent/'ada_body_costume_checkpoint_r003_ART_REVISE.blend'
source_hash=hashlib.sha256(source.read_bytes()).hexdigest()
assert source_hash=='03829ab406d6bd5e6a1c5f86e045e9f2edc720b05e620e70017667c59be8b3f8'
...
report={'source':'ada_body_costume_checkpoint_r003_ART_REVISE.blend','status':'RUNNING','frame_count':169,'objects':[o.name for o in objects],'thresholds':{'world':'abs(X)>1.4m or abs(Y)>1.4m or Z>2.2m or Z<−0.3m, or nonfinite','temporal':'a corresponding evaluated vertex moves >0.12m between adjacent 24fps frames; flags require interpretation'},'extreme_vertex_events':[],'temporal_flags':[],'object_summaries':{}}
...
report['source_sha256']=source_hash;report['source_sha256_after']=hashlib.sha256(source.read_bytes()).hexdigest()
