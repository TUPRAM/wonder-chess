...
R=Path(__file__).resolve().parents[1];src=R/'ada_bw5_armor_checkpoint_ART_REVISE.blend'
def action_curves(a):
    out=[]
...
(R/'records/surface_integrity.json').write_text(json.dumps(record,indent=2))
