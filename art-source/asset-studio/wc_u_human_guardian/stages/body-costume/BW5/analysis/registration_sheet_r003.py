...
R=Path(__file__).parent;reg=json.loads((R/'r003_registration_body_anchors.json').read_text())
refpath=Path('C:/Users/iputu/Documents/Wonder Chess/production/asset-studio/supplements/BW5/Wonder_Chess_Proportion_Fit_BW5/references/Ada_supplied_turnaround.png');modelpath=R.parent/'armor/captures/r003_reference_pose_front.png'
...
for im,x,title in [(crop,40,'REFERENCE | supplied pixels'),(aligned,940,'BW5 r003 RETAINED | ART_REVISE')]:
