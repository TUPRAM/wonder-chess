...
R=Path(__file__).parent;source=R.parent/'armor/ada_bw5_armor_checkpoint_r003_ART_REVISE.blend'
...
(R/'r003_registration_body_anchors.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
