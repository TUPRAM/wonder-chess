...
R=Path(__file__).parent;d=json.loads((R/'retained_sections_and_conflicts.json').read_text()); baseline=json.loads((R/'bw4_sections_and_conflicts.json').read_text())
...
draw.text((40,70),'Millimeters, same scale per panel. +Y anterior points up. Frame 1: BW4 frozen baseline and BW5 retained frozen plate shapes.',fill='#364854',font=font(21))
...
im.save(R/'BW4_vs_BW5_retained_torso_sections.png')
