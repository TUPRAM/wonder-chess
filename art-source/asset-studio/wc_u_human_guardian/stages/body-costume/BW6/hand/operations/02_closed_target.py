...
mass('BW6_Thenar_Teardrop_Target',(.025,.048,.011),(.019,.023,.017),(0,math.radians(-12),math.radians(-22)))
...
mass('BW6_Thumb_Distal_Pad_Target',(.028,.0615,.033),(.014,.008,.009),(0,math.radians(15),math.radians(-8)))
