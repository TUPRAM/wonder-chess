...
mass('BW6_Thumb_Distal_Pad_Target',(.027,.0615,.034),(.014,.008,.009),(0,math.radians(15),math.radians(-8)))
...
for name,c,r in [('index',(.027,.099,.005),(.011,.011,.008)),('middle',(.003,.102,.003),(.012,.013,.009)),('ring',(-.019,.097,.002),(.011,.012,.008)),('little',(-.038,.087,.005),(.009,.011,.008))]:mass('BW6_'+name+'_MCP_Target',c,r)
...
gestures={
 ...
 'little':[(-.039,.090,.005),(-.041,.108,.032),(-.040,.090,.055),(-.035,.073,.043)]}
