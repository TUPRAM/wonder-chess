...
gestures={
 ...
 'ring':[(-.019,.100,.002),(-.021,.113,.037),(-.020,.087,.059),(-.017,.064,.045)],
 'little':[(-.039,.102,.006),(-.041,.116,.036),(-.040,.092,.059),(-.035,.069,.048)]}
