...
def append_bw6_shoulder(scene, rig):
    source=Path(__file__).resolve().parents[1]/'ada_bw6_shoulder_checkpoint_r003_ART_REVISE.blend'
    parts=['BW6_Pauldron_R_'+n for n in ['Cap','Lame1','Lame2']]
    helpers=[n+'_Suspension' for n in parts]+['BW6_R_Arm_RestDelta','BW6_R_Shoulder_RestDelta','BW6_R_Cap_StrapPivot','BW6_R_Cap_SecondaryHinge','BW6_R_CapRelative_LameAnchor']
    names=parts+helpers
    ...
    scene['BW6_SHOULDER_STATUS']='ART_REVISE_SUPPORT_IMPROVED_NOT_APPROVED'
