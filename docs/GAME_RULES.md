...
Alpha threshold: two only. Four-unit values remain design data and are neither displayed nor activated in the alpha. Humans +10% health, Elves +10% attack rate, Dwarves +10 armor, Orcs +10% direct damage. Guardians +15 armor, Warriors/Rangers +15% basic damage, Rogues +15% attack rate, Mages +20% active damage, Priests +15% support magnitude as defined above. These are proposed numeric starting points.
