...
All 24 heroes are fully described. The first twelve are the playable-alpha design set; the remaining twelve are expansion designs, not initial asset obligations. Numbers are prototype values, not validated balance.
## Master roster
| Hero | Race | Class | Cost | Phase | Active skill |
|---|---|---|---:|---|---|
| Ada Brightshield | human | guardian | 1 | alpha | Sunward Guard |
| Mira Dawnwell | human | priest | 1 | alpha | Mend |
| Rowan Emberwick | human | mage | 2 | alpha | Ember Orb |
| Liora Leafstep | elf | ranger | 1 | alpha | Leafstep |
| Elin Moonsong | elf | priest | 2 | alpha | Quickening Song |
| Sylas Duskrun | elf | rogue | 3 | alpha | Backline Dash |
| Borin Stonebell | dwarf | guardian | 1 | alpha | Bell Stomp |
| Tessa Brassbolt | dwarf | ranger | 2 | alpha | Heavy Bolt |
| Dagna Anvilheart | dwarf | warrior | 2 | alpha | Anvil Sweep |
| Rok Sunward | orc | warrior | 1 | alpha | Battle Tempo |
| Zura Stormcall | orc | mage | 3 | alpha | Storm Ring |
| Kesh Quickwind | orc | rogue | 2 | alpha | Closing Dash |
| Cass Vale | human | warrior | 2 | expansion | Resolute Strike |
| Neris Starbloom | elf | mage | 3 | expansion | Starbind |
| Orla Hearthglow | dwarf | priest | 2 | expansion | Hearth Pulse |
| Tala Ironroot | orc | guardian | 2 | expansion | Shared Guard |
| Pippa Oakstride | halfling | warrior | 1 | expansion | Stout Heart |
| Finn Thistlearrow | halfling | ranger | 1 | expansion | Dulling Shot |
| Nella Quickpocket | halfling | rogue | 2 | expansion | Quick Feint |
| Milo Mistwhistle | halfling | mage | 2 | expansion | Mist Pop |
| Sora Dawnscale | dragonkin | guardian | 3 | expansion | Beacon Guard |
| Varek Prismshot | dragonkin | ranger | 2 | expansion | Prism Shot |
| Iri Cinderstep | dragonkin | rogue | 3 | expansion | Prism Cut |
| Oren Skyward | dragonkin | priest | 2 | expansion | Skyward Ward |
...
**Halfling · Rogue · Disruption · EXPANSION**

Stable identity: `wc_u_halfling_rogue`. Cost: **2 gold**. Rarity label: **Uncommon**, separate from star level. Status: designed, not modeled or implemented by this kit. All combat values are provisional prototype inputs.
